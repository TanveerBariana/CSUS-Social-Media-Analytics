...
inputdata = pandas.read_csv('spotifyscrapper\example8results.csv', header=[0], index_col=0).to_dict()
...
results.to_csv('spotifyscrapper\example13results.csv', index=True, index_label="Index")
print("done")
