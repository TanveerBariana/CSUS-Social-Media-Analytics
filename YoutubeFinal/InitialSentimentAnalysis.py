...
inputdata={}
inputfile = pandas.read_csv('YoutubeFinal\Caption4.csv', header=[0])
...
file.to_csv('YoutubeFinal\Sentiment4.csv', index=True, index_label="Index")
