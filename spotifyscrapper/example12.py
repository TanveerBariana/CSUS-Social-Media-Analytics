...
inputdata = pandas.read_csv('spotifyscrapper\example11results.csv', header=[0], index_col=0).to_dict()
...
file = pandas.read_csv('spotifyscrapper\example11results.csv')
file['Emotion'] = emotionresults_list

file.to_csv('spotifyscrapper\example12results.csv', index=False)
print("done")
